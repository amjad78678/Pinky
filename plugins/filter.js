...
//===========start of bgm reply ================ 
    const barray = ["name entha","helo","king","‎pavam","‎Aa da","‎Aa","Aaa","Age","Air","alive","Aliya","Audio","Ayn","Back","Bgm","Bgm1","Bgm2","Bgm3","Bgm4","Bgm5","Bgm6","Bgmi","big fan","Block","Bott chathu","Business","Busy","charlie","Chaya","Complan","Dora","Dude","ennitt","Fan","Ff","Food","Football","Free fire","Friend","gd n8","git","Group active","Group chathu","Gud nyt","Hacker","Happy","Happy birthday","Hbd","Hello","Hlo","Home","I love you","Ijjathi","insta","Insult","Isl","Ivan","Jerry","Jocker","Kannappi","kar 98","Kollatte","Kollum","Line","Lm10","lub","M","Maalutty","manassilayo","Mandan","Mass","mention","menu","Mm","Mng","Mole","Naayi","Name","name entha","Nee etha","Amj","Amjad ali","Nikk","nirthada","Njr","Paamb","Parayula","pavam","Pes","photo","Poda","Podi","Pottan","Pova","Povalle","Povano","Poweresh","Poyo","Pubg","Return","Ronaldo","Sarasu","Sed akki","Senti","Sp","Sry","Start","sticker","list","Thair","Thamasha","Time","Troll","Uff","Unda","Undakkanni","Va","Vada","Vazhe","Veruppikkalle","video","Vilikk","What","Xxxtentaction","Z aayi","kooi","love","thamasha","big fan","charlie","gd n8","kar98","love u","endi","noob","poweresh","perfect ok","power","saji","sed","single","waiting","myr","malappuram","uyir","thug","avastha","moodesh","sketched","cr7","z aayi","manasilayo","hi","hlo","poda","nirtheda","aarulle","cr7 back","portugal","ennitt","boss","haters","ayn","kgf","sed bgm","messi","hehe","set aano","bot myren","venda","chadhi","hbday","bot","r yyi padicho","myre","umbi","parayatte","fresh","ok da","feel aayi","feel aaayi","scene","ok bei","da","kozhi","adi","kali","thantha","aysheri","thund","thot","sneham","pm","paatt","njan","life","killadi","good bye","evide","achan","kunna","broken","why","enth patti","pani","padicho","paad","chatho","lover","nanayikoode","die","hate","lamiya engineering","nallath","neymer","patti","poora","rohit","thall","theri","potte","pinky","caption","onn poyi","problem","chill","help","kunda","povano","sthalam","tholvi","vannu","pinkymol","malayalam","vaa","lub","ayin","thyr","sad","kiss","baby","voice","admin","remove","sorry","owner","gud nyt","dream","bye","Amjad","Group"]
